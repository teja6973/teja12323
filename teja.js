...
app.post('/signin', async (req, res) => {
    ...
    try {
      const userRef = db.collection('mani').where('email', '==', email).where('password', '==', password);
...
app.listen(3100, _ => console.log('Server is running on port 3000'));
